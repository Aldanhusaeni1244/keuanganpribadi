...
var API_URL = "/api"; // Pakai relative path biar otomatis
  ...
  fetch(API_URL + "/transactions")
    ...
    .catch(function (error) {
      ...
      transactionList.innerHTML =
        '<div class="empty-state"><p style="color:#e74c3c;">Gagal koneksi ke server!</p></div>';
    });
}
...
function renderTransactionList() {
  if (transactions.length === 0) {
    transactionList.innerHTML =
      '<div class="empty-state"><p>Belum ada transaksi. Tambahkan sekarang!</p></div>';
    return;
  }
  var html = "";
  for (var i = 0; i < transactions.length; i++) {
